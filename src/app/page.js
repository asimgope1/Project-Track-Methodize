          ...
          <div className="table-responsive">
            <table className="table table-hover align-middle mb-0" style={{ backgroundColor: "white" }}>
              <thead className="table-light">
                <tr>
                  <th className="ps-4 py-3 fw-bold text-secondary text-uppercase fs-7" style={{ minWidth: "300px" }}>Module Name</th>
                  <th className="text-center py-3 fw-bold text-secondary text-uppercase fs-7" style={{ minWidth: "200px" }}>Process</th>
                  <th className="text-center py-3 fw-bold text-secondary text-uppercase fs-7" style={{ minWidth: "200px" }}>Stage</th>
